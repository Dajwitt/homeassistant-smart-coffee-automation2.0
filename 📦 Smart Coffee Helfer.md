...
```
"Bereit für den nächsten Schritt?" [So legst du die Sensoren & Templates an](https://github.com/Dajwitt/homeassistant-smart-coffee-automation3.0/blob/main/readme.md#-schritt-3-sensoren--templates-einf%C3%BCgen)
